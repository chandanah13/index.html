...
<div class="banner-top">
			<div class="social-bnr-agileits">
				<ul class="social-icons3">
								...
								<li><a href="https://gmail.com/" class="fa fa-google-plus icon-border googleplus"> </a></li>
							</ul>
			</div>
			<div class="contact-bnr-w3-agile">
				<ul>

					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:thepalmbliss@gmail.com">thepalmbliss@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91-8095674522</li>
				</ul>
			</div>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">THE PALM BLISS <span>Bengaluru</span><p class="logo_w3l_agile_caption">  The 5 Star Hotel</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="http://localhost/HOTEL_ORIGINAL/admin/index.php">Admin Login</a></li>
						</ul>
					</nav>
				</div>
			</nav>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>THE PALM BLISS <span>Bengaluru</span></h4>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">The PALM BLISS</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91-8095674522</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:codeprojectsorg@gmail.com">thepalmbliss@gmail.com</a></p>
			<p> class="contact-agile1"><strong>Address :</strong> Rajajinagar-aBangalore</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>Thank you for visiting us|THE PALM BLISS</p>
		    </div>
<!--/footer -->
<!-- js -->
